    ...
    function (task, email, runtime, search, record, format, https) {
        ...
        function execute(context) {
            ...
            resultSetLPOLeadProfile.each(function (searchResult) {
                ...
                var primaryContactId = leadRecord.getValue({
                ...
                if (primaryContactId) {
                    ...
                    lpoContactFName = contactRecord.getValue({ fieldId: 'firstname' });
                    lpoContactLName = contactRecord.getValue({ fieldId: 'lastname' });
                    lpoContactEmail = contactRecord.getValue({ fieldId: 'email' });
                    lpoContactPhone = contactRecord.getValue({ fieldId: 'phone' });
                    ...
                    lpoContactDetails += '"first_name": {"stringValue": "' + lpoContactFName +
                        '"},';
                    lpoContactDetails += '"last_name": {"stringValue": "' + lpoContactLName +
                        '"},';
                    lpoContactDetails += '"email": {"stringValue": "' + lpoContactEmail +
                        '"},';
                    lpoContactDetails += '"phone": {"stringValue": "' + lpoContactPhone +
                        '"},';
                    lpoContactDetails += '"lpo_id": {"stringValue": "' + linkedParentCustomerInternalID +
                        '"},';
                    lpoContactDetails += '"role": {"stringValue": "admin"}}}';

                    var urlCreateUser =
                        'https://firestore.googleapis.com/v1/projects/mp-lpo-connect/databases/lpoconnect/documents/users?documentId=' + authID;
                ...
                searched_addresses.run().each(function (
                    resultSetAddresses) {
                ...
                lpoDetails += '"lpo_id": {"stringValue": "' + linkedParentCustomerInternalID +
                    '"},';
                lpoDetails += '"name": {"stringValue": "' + lpoName +
                    '"},';
                lpoDetails += '"address1": {"stringValue": "' +
                    address1 + '"},';
                lpoDetails += '"street": {"stringValue": "' +
                    address2 + '"},';
                lpoDetails += '"city": {"stringValue": "' + suburb +
                    '"},';
                lpoDetails += '"Location": {"stringValue": "' + suburb +
                    '"},';
                lpoDetails += '"state": {"stringValue": "' +
                    state + '"},';
                ...
                if (getServiceRate(serviceList, 'PMPO') != null) {
                    ...
                    lpoDetails += '"lpoServicePMPOInternalID": {"stringValue": "' + servicePMPO.id + '"},';
                    lpoDetails += '"lpoServicePMPORate": {"stringValue": "' + servicePMPO.rate + '"},';
                }
                if (getServiceRate(serviceList, 'AMPO') != null) {
                    var serviceAMPO = getServiceRate(serviceList, 'AMPO');
                    lpoDetails += '"lpoServiceAMPOInternalID": {"stringValue": "' + serviceAMPO.id + '"},';
                    lpoDetails += '"lpoServiceAMPORate": {"stringValue": "' + serviceAMPO.rate + '"},';
                }
                if (getServiceRate(serviceList, 'Package: AMPO & PMPO') != null) {
                    var serviceAMPOPMPO = getServiceRate(serviceList, 'Package: AMPO & PMPO');
                    lpoDetails += '"lpoServicePackageInternalID": {"stringValue": "' + serviceAMPOPMPO.id + '"},';
                    lpoDetails += '"lpoServicePackageRate": {"stringValue": "' + serviceAMPOPMPO.rate + '"},';
                }
                ...
                var urlCreateLPO =
                    'https://firestore.googleapis.com/v1/projects/mp-lpo-connect/databases/lpoconnect/documents/lpo?documentId=' + linkedParentCustomerInternalID;
