...
define(['N/task', 'N/email', 'N/runtime', 'N/search', 'N/record', 'N/format',
    ...
    function (task, email, runtime, search, record, format, https) {
        ...
        function execute(context) {
            ...
            var tomorrowDateYYYYMMDD = getTomorrowsDate();
            log.audit({
                title: 'Tomorrow Date',
            ...
            for (var i = 0; i < responseObj.length; i++) {
                ...
                var netsuiteLPOServiceDateDateFormat = dateSelected2Date('' + flat.date + '');
                ...
                var customerContactName = flat["customer.firstName"] + ' ' + flat["customer.lastName"];
                ...
                //         'https://firestore.googleapis.com/v1/projects/mp-lpo-connect/databases/lpoconnect/documents/jobs/' + job_id + '?updateMask.fieldPaths=stops&updateMask.fieldPaths=appJobGroupId&updateMask.fieldPaths=syncedWithNetSuite';
                //     var apiHeaders = {};
                //     apiHeaders["Content-Type"] = "application/json";
                //     apiHeaders["Accept"] = '*/*';
            ...
            for (var key in obj) {
                ...
                if (value && typeof value === 'object') {
                    if ('stringValue' in value) {
                        ...
                        extractKeyValuePairs(value.mapValue.fields, prefix + key + '.', result);
                    } else {
