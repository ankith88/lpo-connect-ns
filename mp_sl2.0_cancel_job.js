 ...
 * Created on:           2026-06-18 06:55:42
 * Modified on:          2026-06-18 06:55:46
 * SuiteScript Version:  2.0
 * Description:          Suitelet to be called from LocalMile.PLUS to cancel a job before the driver has accepted it.
 *
...
define([
  ...
  function onRequest(context) {
    ...
    if (context.request.method === "GET") {
      ...
      //Search Name: LocalMile.PLUS - Jobs Not Completed
      var lmpJobsNotCompletedSearch = search.load({
        type: "customrecord_jobgroup",
        id: "customsearch_lmp_jobs_not_complete"
      });
      lmpJobsNotCompletedSearch.filters.push(
        search.createFilter({
          name: "custrecord_lmp_job_id",
          join: null,
      ...
      var jobCount = 0;
      lmpJobsNotCompletedSearch.run().each(function (resultSet) {
